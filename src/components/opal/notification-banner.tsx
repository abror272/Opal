...
export function NotificationBanner() {
  ...
  return (
    <div className="absolute inset-x-4 top-14 z-40 animate-slide-up">
      <div className="overflow-hidden rounded-3xl bg-white/95 shadow-2xl shadow-slate-900/25 ring-1 ring-slate-200 backdrop-blur-xl">
        <div className="flex items-center gap-2 border-b border-slate-100 px-4 py-2">
          <span className="text-[11px]">📱</span>
          <span className="text-[11.5px] font-bold uppercase tracking-wide text-slate-500">Opal</span>
        ...
        <div className="grid grid-cols-2 divide-x divide-slate-100 border-t border-slate-100">
          <button
            ...
            className="py-3 text-[14px] font-semibold text-slate-400 transition-colors hover:bg-slate-50"
          >
            Hozir emas
          </button>
          <button
            onClick={() => decide(true)}
            className="py-3 text-[14px] font-bold text-[#3d5afe] transition-colors hover:bg-indigo-50/50"
          >
            Ruxsat berish
          </button>
        </div>
